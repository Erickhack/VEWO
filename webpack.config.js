...
module.exports = {
  ...
  plugins: [
    ...
    new HtmlWebpackPlugin({
      template: "./assets/html/profil.html",
      filename: "profil.html",
      minify: false, // Disable minification during production mode
      hash: true,
    }),
    new HtmlWebpackPlugin({
      template: "./assets/html/rulsgame.html",
      filename: "rulsgame.html",
      minify: false, // Disable minification during production mode
      hash: true,
    }),
    new HtmlWebpackPlugin({
      template: "./assets/html/scan.html",
      filename: "scan.html",
      minify: false, // Disable minification during production mode
      hash: true,
    }),
    new HtmlWebpackPlugin({
      template: "./assets/html/settings.html",
      filename: "settings.html",
      minify: false, // Disable minification during production mode
      hash: true,
    }),
    new HtmlWebpackPlugin({
      template: "./assets/html/testyourself.html",
      filename: "testyourself.html",
      minify: false, // Disable minification during production mode
      hash: true,
    }),
